...
<div class="row">
	<div id="divAppart" class="col l8 m8 s10 offset-l2 offset-m2 offset-s1 hide-on-small-only">
		<h1 id="titre" class="white-text center">T4 - Revard</h1>
	</div>

	<div class="col l6 m8 s12 offset-l3 offset-m2 center" style="padding: 0;">
		<ul class="pgwSlideshow">
			<li><img src="images/T4-revard/revard-1.jpg"></li>
			<li><img src="images/T4-revard/revard-2.jpg"></li>
			<li><img src="images/T4-revard/revard-3.jpg"></li>
			<li><img src="images/T4-revard/revard-4.jpg"></li>
			<li><img src="images/T4-revard/revard-5.jpg"></li>
			<li><img src="images/T4-revard/revard-6.jpg"></li>
			<li><img src="images/T4-revard/revard-7.jpg"></li>
			<li><img src="images/T4-revard/revard-8.jpg"></li>
			<li><img src="images/T4-revard/revard-9.jpg"></li>
			<li><img src="images/T4-revard/revard-10.jpg"></li>
			<li><img src="images/T4-revard/revard-11.jpg"></li>
			<li><img src="images/T4-revard/revard-12.jpg"></li>
			<li><img src="images/T4-revard/revard-13.jpg"></li>
			<li><img src="images/T4-revard/revard-14.jpg"></li>
			<li><img src="images/T4-revard/revard-15.jpg"></li>
		</ul>
	</div>
	...
	<div class="row">
		<div class="col l6 m8 s12 offset-l3 offset-m2 primary white-text center description">
			<h5 class="">Appartement meublé 4 pièces</h5>
			<br>
			<hr width="50px">
		</div>
		...
		<div class="col l6 m8 s12 offset-l3 offset-m2 white descriptionWithoutTop withoutMarginBot">
			...
			<div class="row">
				<div class="col s12">
					...
					Un salon avec convertible en 140 et TV.<br>
					Une buanderie avec LL cumulus et WC (Sanibroyeur).<br>
					2 chambres avec lits de 140 rangements et bureau + une chambre sous toiture avec 2 lits de 90 (hauteur maxi 180).<br>
					Une SdB avec une douche de 100/90 à l’italienne, un meuble avec lavabo et un WC (Sanibroyeur).
				</div>
			</div>
